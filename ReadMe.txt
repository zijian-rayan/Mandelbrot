...
L'Assistant Application a créé cette application ShowFract pour
...
ShowFract.h
    ...
    classe d'application CShowFractApp.
...
res\Toolbar.bmp
    ...
    IDR_MAINFRAME TOOLBAR dans ShowFract.rc afin d'ajouter des 
...
StdAfx.h, StdAfx.cpp
    ...
    nommé ShowFract.pch et un fichier de types précompilé nommé 
    StdAfx.obj.
